...
import { KodAnimationCurves, KodAnimationDurations } from 'src/app/services/animations/defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${KodAnimationDurations.entering} ${KodAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${KodAnimationDurations.exiting} ${KodAnimationCurves.acceleration}`
                }
            }
        )
    ]
